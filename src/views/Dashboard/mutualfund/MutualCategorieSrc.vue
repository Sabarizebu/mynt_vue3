          ...
          <v-card style="border: 1px solid var(--outline)" variant="outlined" class="elevation-0 rounded-lg mb-8 mb-md-0 crd-trn">
            <v-toolbar class="tool-sty elevation-0 py-4 mb-7 px-4 crd-trn" density="compact">
              <v-list-item v-if="paramsdata && paramsdata.title" class="pl-0">
                ...
                <v-list-item-title class="font-weight-bold title">{{ paramsdata.title }}</v-list-item-title>
              ...
              <v-text-field style="max-width: 160px" v-model="opensearch" hide-details prepend-inner-icon="mdi-magnify" label="Search" class="rounded-pill ml-1 d-none d-md-flex" density="compact" variant="solo" flat
